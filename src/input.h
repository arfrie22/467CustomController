...
#if SIMULATION_COUNT == t
#define HID_DESC_SIMULATION_BYTES 14 + (SIMULATION_COUNT * 2) + 3
#else
#define HID_DESC_SIMULATION_BYTES 0
#endif //SIMULATION_COUNT == t

#define HID_DESC_END_BYTES 1

#define HID_REPORT_DESC_LENGTH HID_DESC_START_BYTES + HID_DESC_BUTTON_BYTES + HID_DESC_DESC_HAT_BYTES + HID_DESC_AXIS_BYTES + HID_DESC_SIMULATION_BYTES + HID_DESC_END_BYTES
